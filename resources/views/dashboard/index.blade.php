...
<div class="space-y-6">
                ...
                <p class="text-primary-100">
                    @php
                        ...
                        if ($hour >= 5 && $hour < 12) {
                            ...
                            echo 'Selamat Siang! Jangan lupa istirahat.';
                        } elseif ($hour >= 15 && $hour < 18) {
                            echo 'Selamat Sore! Tetap semangat.';
                        } else {
                            echo 'Selamat Malam! Jangan lupa istirahat ya.';
                        }
                    @endphp
                </p>
            </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        <div class="bg-white rounded-xl p-6 shadow-sm border border-gray-100">
            <div class="flex items-center justify-between mb-4">
                ...
                <span class="text-xs font-medium text-orange-600 bg-orange-100 px-2 py-1 rounded-full">Hari ini</span>
            </div>
            <h3 class="text-2xl font-bold text-gray-900">0%</h3>
    ...
    <div class="bg-white rounded-xl p-8 shadow-sm border border-gray-100">
        <div class="text-center py-12">
            ...
            <h3 class="text-lg font-semibold text-gray-900 mb-2">Dashboard dalam Pengembangan</h3>
            <p class="text-gray-500 max-w-md mx-auto">
                Konten dashboard seperti chart, statistik, dan laporan akan ditambahkan pada tahap selanjutnya.
            </p>
        </div>
    </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div class="flex items-center space-x-3 p-3 bg-gray-50 rounded-lg">
                ...
                <div>
                    ...
                    <p class="text-sm font-medium text-gray-900 capitalize">{{ Auth::user()->role ?? 'User' }}</p>
                </div>
            </div>
            <div class="flex items-center space-x-3 p-3 bg-gray-50 rounded-lg">
                ...
                <div>
                    ...
                    <p class="text-sm font-medium text-gray-900">{{ date('d F Y') }}</p>
                </div>
            </div>
            <div class="flex items-center space-x-3 p-3 bg-gray-50 rounded-lg">
                ...
                <div>
                    ...
                    <p class="text-sm font-medium text-gray-900" id="server-time">{{ date('H:i:s') }}</p>
                </div>
            </div>
        </div>
    </div>
