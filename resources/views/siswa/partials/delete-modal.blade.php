...
<div x-show="showDeleteModal" 
    ...
    <div x-show="showDeleteModal"
        ...
        <div class="p-8 text-center">
            ...
            {{-- Title --}}
            <h3 class="text-xl font-bold text-gray-900 mb-2" x-text="deleteType === 'single' ? 'Hapus Siswa?' : 'Hapus ' + selectedItems.length + ' Siswa?'"></h3>
            
            {{-- Description --}}
            <template x-if="deleteType === 'single'">
                <p class="text-gray-600 mb-6">
                    Apakah Anda yakin ingin menghapus data siswa <span class="font-semibold text-gray-900" x-text="deleteTarget?.nama_lengkap"></span>? 
                    Tindakan ini tidak dapat dibatalkan.
                </p>
            </template>
            <template x-if="deleteType === 'bulk'">
                <p class="text-gray-600 mb-6">
                    Apakah Anda yakin ingin menghapus <span class="font-semibold text-gray-900" x-text="selectedItems.length"></span> siswa yang dipilih? 
                    Tindakan ini tidak dapat dibatalkan.
                </p>
            </template>
